...
public class ConnectionUtils {
    ...
    public static java.sql.Connection getConnection() {
        ...
        try {
            ...
            String serveName = "bancomodelo.mysql.uhserver.com:3306"; // Caminho do servidor do BD
            String mydatabase = "bancomodelo"; // Nome do banco de dados
            String url = "jdbc:mysql://" + serveName + "/" + mydatabase;
            String username = "jonatahessa"; // Nome de usuario
